...
class BaseAPI(
        ...
        self._router = fastapi.APIRouter(
            ...
            responses={
                404: {
                    ...
                    "description": f"{name} entity not found",
                },
    ...
    async def create(
        self, schema: T_EntityCreateSchema, background_tasks: fastapi.BackgroundTasks
    ) -> T_EntityGetSchema | TaskGetSchema:
        """
